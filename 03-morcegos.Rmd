...
```{r 04, echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "Riqueza potencial de espécies de morcegos modelada para o Brasil."}

knitr::include_graphics("imagens/figura04.png")
